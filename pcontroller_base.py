...
class controller():
    ...
    def control_law(self):
        ...
        ux = self.k_position * (self.goal_x - self.current_x)
        uy = self.k_position * (self.goal_y - self.current_y)
    ...
    def move2goal(self):
        ...
        while not rospy.is_shutdown():
            ...
            speed = Twist()
            speed.linear.x = self.k_vel * ux
            speed.linear.y = self.k_vel * uy
            speed.linear.z = self.k_vel * uz
            speed.angular.x = 0
            speed.angular.y = 0
            speed.angular.z = self.k_angvel * uw
